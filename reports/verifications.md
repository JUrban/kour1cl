...
| 20.78 (Qian codegree conjecture) | element of order m ⇒ m divides some codegree | all non-soluble groups of order ≤ 2000 with F(G) ≠ 1, all 2275 library tables with ≤ 300 classes, and all perfect groups of order < 10⁶ with F(G) ≠ 1 (running): no counterexample | `work/p20_78` |
