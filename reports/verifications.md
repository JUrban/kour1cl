...
| 19.56 (Monakhov) | (M): |ab| ≥ |a||b| for ⋆-commutators of coprime orders ⇒ soluble? | all 208 non-soluble groups of order ≤ 2000 (orders with ≤ 5000 groups) and SL(2,q), PSL(2,q) (q ≤ 32, 64), Sz(8), PSL(3,3): every one violates (M) (explicit pairs in the log); every minimal simple group violates (M) by the theorem in the report | `work/p19_56` |
