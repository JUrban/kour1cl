...
The partial results are of a different kind. For 16.14 and 20.37 the agent proved genuine theorems (a structure
theorem for minimal counterexamples; a perfect-matching theorem for coset unions) that reduce the problems to
...
two impossibility lemmas and searched further than the previous state of knowledge (the problem's comment asks
for a group of order at least 6144). In each case the report states precisely what is proved and what is
computed.
...
What did not work: attempts at general proofs where the problem is genuinely hard (the general case of 16.14, the
Frattini lifting in 19.56, the $t=4$ case of 20.21); the agent recognised this fairly quickly each time and moved to
