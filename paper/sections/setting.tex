...
tries to end its turn, so that the agent works continuously without further human input. After roughly one hour one of the
experimenters re-issued the goal (``resume''), which also changed the reasoning-effort setting (see below). At the
end of the 48 hours the experimenters asked for the present paper.
...
15\,364 lines). The 21st edition lists the problems of all issues 1--21 that had not been moved to the archive of solved problems
by the previous edition (2022); problems solved since then, or solved earlier without a published detailed
solution, remain in the main part marked by an asterisk and commented (about 105 marks). The new problems of the
21st issue occupy lines 7885--9065 of the text file. None of the twelve
